...
case node['ec2']['instance_size']
  when 'm1.small'
    set_unless[:db_mysql][:tunable][:innodb_log_file_size]          = "100M"
  when 'm1.large'
    set_unless[:db_mysql][:tunable][:innodb_log_file_size]          = "255M"
  default
    set_unless[:db_mysql][:tunable][:innodb_log_file_size]          = "10M"
end
